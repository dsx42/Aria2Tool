...
* 支持 Windows 10/11 和 OpenWrt 22.03.5

# 下载

## Windows 10/11

从如下链接下载最新的版本：`Aria2Tool_v2023.5.23.zip`
...
```bash
wget -O /aria2_tool_openwrt.sh 'https://github.com/dsx42/Aria2Tool/releases/download/v2023.5.23/aria2_tool_openwrt.sh'
```
...
wget -O /etc/aria2/aria2_tool_openwrt.sh 'https://github.com/dsx42/Aria2Tool/releases/download/v2023.5.23/aria2_tool_openwrt.sh'
# 安装 Aria2，并指定下载文件目录
