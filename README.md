...
从如下链接下载最新的版本：`Aria2Tool_v2024.10.1.zip`
...
```bash
wget -O /aria2_tool_openwrt.sh 'https://github.com/dsx42/Aria2Tool/releases/download/v2024.10.1/aria2_tool_openwrt.sh'
```
...
wget -O /etc/aria2/aria2_tool_openwrt.sh 'https://github.com/dsx42/Aria2Tool/releases/download/v2024.10.1/aria2_tool_openwrt.sh'
# 安装 Aria2，并指定下载文件目录
